...
public class RelatedFoodListAdapter extends ArrayAdapter<FoodPair> {
    ...
    public RelatedFoodListAdapter(Context context, ArrayList<FoodPair> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.related_food_list_item, parent, false);
        }
        final TextView tvTitleLeft = (TextView) convertView.findViewById(R.id.tv_related_food_title_left);
        TextView tvDescriptionLeft = (TextView) convertView.findViewById(R.id.tv_related_food_description_left);
        TextView tvPriceLeft = (TextView) convertView.findViewById(R.id.tv_related_food_price_left);
        final ImageView ivPhotoLeft = (ImageView) convertView.findViewById(R.id.iv_related_food_photo_left);
        final ImageButton btnLikeLeft = (ImageButton) convertView.findViewById(R.id.btn_related_food_like_left);
        ImageView ivCreatedUserPhotoLeft = (ImageView) convertView.findViewById(R.id.iv_related_food_created_user_photo_left);
        ...
        if (item.getFoodRight() != null) {
            ...
            TextView tvDescriptionRight = (TextView) convertView.findViewById(R.id.tv_related_food_description_right);
            TextView tvPriceRight = (TextView) convertView.findViewById(R.id.tv_related_food_price_right);
            final ImageView ivPhotoRight = (ImageView) convertView.findViewById(R.id.iv_related_food_photo_right);
            final ImageButton btnLikeRight = (ImageButton) convertView.findViewById(R.id.btn_related_food_like_right);
            ImageView ivCreatedUserPhotoRight = (ImageView) convertView.findViewById(R.id.iv_related_food_created_user_photo_right);
